...
.ytrawl-icon-btn { color: ${c.on_surface_variant}; transition-duration: 100ms; }
.ytrawl-icon-btn:hover,
.ytrawl-icon-btn:focus { background-color: ${RGBA(c.on_surface, 0.08)}; color: ${c.on_surface}; }
...
.ytrawl-pill:hover,
.ytrawl-pill:focus { background-color: ${c.surface_container_highest}; }
.ytrawl-pill:checked {
...
.ytrawl-primary:hover,
.ytrawl-primary:focus { background-color: ${c.tertiary}; color: ${c.on_tertiary}; }
...
.ytrawl-ghost:hover,
.ytrawl-ghost:focus { background-color: ${c.secondary_container}; color: ${c.on_secondary_container}; }

/* ---- accordion ------------------------------------------------------ */
.ytrawl-accordion-header { border-radius: 10px; padding: 8px 10px; margin-top: 2px; }
.ytrawl-accordion-header:hover,
.ytrawl-accordion-header:focus { background-color: ${c.surface_container}; }
...
.ytrawl-dropdown:hover,
.ytrawl-dropdown:focus { background-color: ${c.surface_container_high}; }
...
.ytrawl-history-item { color: ${c.on_surface_variant}; }
.ytrawl-history-item:hover {
    color: ${c.on_surface};
    background-color: ${c.surface_container_high};
}
