...
export function iconButton({ icon, tooltip, onActivate, styleClass = 'ytrawl-icon-btn', x_expand = false }) {
...
export function accordion({ titleText, valueText = '', content, defaultOpen = false, onToggleOpen }) {
    ...
    const chevron = stWidget(St.Button, { style_class: 'ytrawl-chevron', can_focus: true });
